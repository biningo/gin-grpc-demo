...
func (x *AMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AMsg) ProtoMessage() {}

func (x *AMsg) ProtoReflect() protoreflect.Message {
	mi := &file_a_proto_msgTypes[0]
...
// Deprecated: Use AMsg.ProtoReflect.Descriptor instead.
func (*AMsg) Descriptor() ([]byte, []int) {
	return file_a_proto_rawDescGZIP(), []int{0}
}

func (x *AMsg) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_a_proto_rawDesc = []byte{
	0x0a, 0x07, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x1c, 0x0a,
	0x04, 0x41, 0x4d, 0x73, 0x67, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x27, 0x0a, 0x08, 0x41,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1b, 0x0a, 0x05, 0x45, 0x63, 0x68, 0x6f, 0x41,
	0x12, 0x08, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x4d, 0x73, 0x67, 0x1a, 0x08, 0x2e, 0x70, 0x62, 0x2e,
	0x41, 0x4d, 0x73, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_a_proto_depIdxs = []int32{
	0, // 0: pb.AService.EchoA:input_type -> pb.AMsg
	0, // 1: pb.AService.EchoA:output_type -> pb.AMsg
